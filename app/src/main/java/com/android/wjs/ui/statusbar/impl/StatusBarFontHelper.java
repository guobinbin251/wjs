...
public class StatusBarFontHelper {
     ...
     */
    public static int setStatusBarMode(@NonNull Activity activity, boolean isFontColorDark) {
     ...
     */
    public static void setLightMode(@NonNull Activity activity, @SystemType int type) {
     ...
     */
    public static void setDarkMode(@NonNull Activity activity, @SystemType int type) {
        setStatusBarMode(activity, type, false);
    }

    private static void setStatusBarMode(@NonNull Activity activity, @SystemType int type, boolean isFontColorDark) {
        if (type == MIUI) {
